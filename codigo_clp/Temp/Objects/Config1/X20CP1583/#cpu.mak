...
export AS_CPU_PATH_2 := C:/Users/supervisorio/Documents/miguel_a214_trabalho_final/MiguelA214Projeto/Temp//Objects/$(AS_CONFIGURATION)/$(AS_PLC)
...
$(AS_BINARIES_PATH)/$(AS_CONFIGURATION)/$(AS_PLC)/Transfer.lst: \
	...
	@"$(AS_BIN_PATH)/BR.AS.FinalizeBuild.exe" "$(AS_PROJECT_PATH)/MiguelA214Projeto.apj" -t "$(AS_TEMP_PATH)" -o "$(AS_BINARIES_PATH)" -c "$(AS_CONFIGURATION)" -i "C:/BrAutomation/AS41" -S "X20CP1583"   -A "X20CP1583" -pil   -swFiles "$(AS_PROJECT_PATH)/Physical/Config1/X20CP1583/Cpu.sw" -C "/RT=1000 /AM=* /SDT=5 /DAIP=192.168.0.70 /REPO=11159 /ANSL=1 /PT=11169" -D "/IF=tcpip /LOPO=11159 /SA=1" -M IA32 -T SG4

#nothing to do (just call module make files)

include $(AS_CPU_PATH)/OpcUaMap/OpcUaMap.mak
include $(AS_CPU_PATH)/iomap/iomap.mak
include $(AS_CPU_PATH)/ProjetoMig/ProjetoMig.mak
